...
try:
    ...
    d = pickle.load(f)
    w1, w2, b1, b2 = d.get('w1'), d.get('w2'), d.get('b1'), d.get('b2')
    f.close()
...
bpnn1 = neural_network_with_one_hidden_layer(n_shape,49,n_label,learning_rate = 0.1, w1=w1, w2=w2, b1=b1, b2=b2)
...
for i in range(10000):
    ...
    if i % 100 == 0:
        ...
        w1, w2, b1, b2 = bpnn1.getWeights()
        d = dict(w1=w1, w2=w2, b1=b1, b2=b2)
